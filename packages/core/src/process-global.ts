 ...
 * version: two versions of this package in one process are still the one app.
 *
 * Twinned in `@hyperfixation/workflows`'s `process-global.ts`. Neither package can reach the
 * other's internals and a shared export would make four lines public API.
 */
